...
public class Users {
    ...
    //--------------------------------------------------------------------------------------------------
    public String name;
    public String password, dateOfBirth, marriageStatus, relativeName, relativeAge, isTransferedSuceesfully;
    public int accountNumber, amountAccount1, accountNumber2, amountAccount2;
    private Object myDOB;
    ...
    */
    ...
    String CheckMariageStatus(String marriageStatus) {
        ...
        if (marriageStatus.equalsIgnoreCase("married")) {
            ...
            addRelative = sc.nextLine();

            if (addRelative.equalsIgnoreCase("yes")) {
                ...
                AddRelative addetrelative = new AddRelative(relativeName, dateOfBirthRelative);

                if (addetrelative.age.equals("0")) {
    ...
    */
     ...
     */
        ...
        public static String checkAge(String myDOB){
            ...
            Period age = Period.between(LocalDate.parse(myDOB,DateTimeFormatter.ofPattern("dd/MM/yyyy")), today);
            if (Integer.parseInt(String.valueOf(age.getYears())) >= 18) {
    ...
    */
     ...
     */
//--------------------------------------------------------------------------------------------------
        public static void transfer (Users a, Users b){
            Scanner scan = new Scanner(System.in);
            System.out.println("Do you want to transfer between your accounts or different user");
            String s = scan.nextLine();
            System.out.println("kaç para transfer edeceksiniz");
            int transferAmount = scan.nextInt();
            if (s.equalsIgnoreCase("own")) {
                transferAmount = scan.nextInt();
                Account.transferToOwnAccount(a, b, transferAmount);

            }
            if (!s.equalsIgnoreCase("own")) {
                Account.transferOtherUser(a, b, transferAmount);
